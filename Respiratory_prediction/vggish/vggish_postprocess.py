...
class Postprocessor(object):
    ...
    def __init__(self, pca_params_npz_path):
        ...
        assert self._pca_means.shape == (vggish_params.EMBEDDING_SIZE, 1), "Bad PCA means shape: %r" % (
            self._pca_means.shape,
        )
    ...
    def postprocess(self, embeddings_batch):
        ...
        assert embeddings_batch.shape[1] == vggish_params.EMBEDDING_SIZE, "Bad batch shape: %r" % (
